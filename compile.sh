...
g++ -O3 -fopt-info-vec -mavx -o array_addition_autovectorized array_addition.cpp
...
g++ -O3 -fopt-info-vec -mavx -o matrix_copy_autovectorized matrix_copy.cpp
g++ -O3 -fopt-info-vec -mavx -o matrix_copy_prefetch_autovectorized matrix_copy_prefetch.cpp
